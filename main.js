...
function showDescription(userHouse) {
  switch (userHouse) {
    case "Alchemoir":
      return "‘ฉลาดลึก หมั่นฝึกวิชา สรรสร้างสรรพสิ่ง’ ยินดีด้วย! ท่านได้รับคัดเลือกเข้าสู่บ้าน Alchemoir เหล่านักเล่นแร่แปรธาตุทั้งหลาย สีทองแห่งความเมตตาที่ส่องประกาย การกระทำฉลาดลึกล้ำเหลือคณานักของพวกท่านเป็นคุณสมบัติที่ควรค่าแก่การรักษาไว้";
    case "Verdanthorn":
      return "Verdanthorn: นักคิดที่สร้างสิ่งใหม่อย่างเงียบๆ";
    case "Noxmortha":
      return "Noxmortha: นักสังเกตการณ์ลึกซึ้งผู้ไขปริศนา";
    case "Arcarum":
      return "Arcarum: ผู้นำที่ดึงศักยภาพของผู้อื่นได้";
    default:
